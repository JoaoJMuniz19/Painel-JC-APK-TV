(function(){
  ...
  function categoryFor(id){if(id.startsWith('config.'))return 'Config';if(id.startsWith('activator'))return 'Ativadores';if(id.startsWith('package.'))return 'Pacotes APK';return 'Outras funções';}

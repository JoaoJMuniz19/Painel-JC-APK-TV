(function(){
  ...
  const extraCards=[
    ...
    ["painel-clientes.html?secao=configuracao","⚙️","Configuração Geral","Centralize links, senha inicial, teste, assinatura e regras gerais do painel.","Abrir configuração →"],

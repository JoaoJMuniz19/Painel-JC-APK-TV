(function () {
  ...
  document.addEventListener("click", (event) => {
    if (event.target.closest('[data-jc-action="open-config"],[data-jc-action="open-activator"],[data-jc-action="open-digits-mass"],[data-jc-action="open-package"],#jcboxdemo_toggle,#jc_reseller_credit_toggle')) loadConfiguredMiniMedia();
  }, { passive: true });
